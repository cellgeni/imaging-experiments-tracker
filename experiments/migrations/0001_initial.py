    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automated_slide_num', models.IntegerField(blank=True, help_text='These columns are needed only when using the automated plate handler.', null=True)),
                ...
                ('date', models.DateTimeField(default=datetime.datetime.now, help_text='Date that the image was taken')),
                ('measurement', models.CharField(help_text='Measurement number, assigned automatically by the Phenix', max_length=20)),
                ('low_mag_reference', models.CharField(blank=True, help_text='A low magnification image (e.g. 5X or 10X scan of the whole slide with DAPI only) may be used as a reference for other images, in alignment and/or viewing. For other images, the related image number should be referenced.', max_length=20, null=True)),
                ('mag_bin_overlap', models.CharField(blank=True, help_text='Magnification, binning level, and tile overlap for the image', max_length=20, null=True)),
                ('z_planes', models.CharField(blank=True, help_text='Number of z-planes x depth of each z-plane', max_length=20, null=True)),
                ...
                ('experiment', models.ForeignKey(help_text='Pre-validated list of T283 projects', null=True, on_delete=django.db.models.deletion.SET_NULL, to='experiments.Experiment')),
            ],
        ),
        migrations.CreateModel(
            name='Microscope',
        ...
        migrations.AddField(
            model_name='sample',
            name='tissue',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='experiments.Tissue'),
        ),
        migrations.CreateModel(
            name='Registration',
            fields=[
