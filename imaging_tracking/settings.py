"""
Django settings for imaging_tracking project.
...
ROOT_URLCONF = 'imaging_tracking.urls'
...
WSGI_APPLICATION = 'imaging_tracking.wsgi.application'
...
DATABASES = {
    ...
    os.getenv("LOCAL_POSTGRES", "local_psql"):
        {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': 'postgres',
            'USER': 'postgres',
